...
@section('page_title', 'كشف حساب العميل')
@section('page_subtitle', 'عرض جميع فواتير البيع والدفعات مع الرصيد التراكمي')
...
<form method="GET" action="{{ route('customers.statement', $customer->id) }}" class="mb-4">
    <div class="row g-3 align-items-end">
        ...
        <div class="col-md-4 d-flex gap-2">
            ...
            <a href="{{ route('customers.statement', $customer->id) }}" class="btn btn-outline-secondary rounded-3 w-100">
                تصفير
            </a>
        </div>
    </div>
